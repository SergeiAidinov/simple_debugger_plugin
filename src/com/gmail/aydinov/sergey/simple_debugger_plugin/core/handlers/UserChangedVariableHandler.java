...
public class UserChangedVariableHandler implements UIEventHandler<UserChangedVariableEventDTO>{
	...
	@Override
	public boolean handle(UIEvent<UserChangedVariableEventDTO> uiEvent, StackFrame currentFrame,
			BreakpointEvent breakpointEvent) {
		UIEvent<UserChangedVariableEventDTO> userChangedVariableEventDTO = (UIEvent<UserChangedVariableEventDTO>) uiEvent;
		updateLocalVariable(userChangedVariableEventDTO, currentFrame);
		return true;
	}
