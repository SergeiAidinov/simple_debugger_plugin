...
public class JdiEventLoop implements Runnable, EventLoop {
	...
	public JdiEventLoop(VirtualMachine vm, BreakpointEventHandler breakpointHandler,
			VmLifeCycleHandler vmLifeCycleHandler, TargetApplicationRepresentation targetApplication) {
		this.vm = vm;
	...
	private ITextEditor openEditorForLocation(Location location) throws Exception {
		...
		if (!(part instanceof ITextEditor editor))
			throw new IllegalStateException("Not a text editor");
		return editor;
	}
