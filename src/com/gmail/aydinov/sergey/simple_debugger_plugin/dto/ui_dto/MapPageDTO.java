...
public class MapPageDTO<K, V> {
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> mapType(String mapType) {
            this.mapType = mapType;
            return this;
        }

        public Builder<K, V> totalEntries(int totalEntries) {
            this.totalEntries = totalEntries;
            return this;
        }

        public Builder<K, V> currentPage(int currentPage) {
            this.currentPage = currentPage;
            return this;
        }

        public Builder<K, V> totalPages(int totalPages) {
            this.totalPages = totalPages;
            return this;
        }

        public Builder<K, V> fromIndex(int fromIndex) {
            this.fromIndex = fromIndex;
            return this;
        }

        public Builder<K, V> toIndex(int toIndex) {
            this.toIndex = toIndex;
            return this;
        }

        public Builder<K, V> entries(List<PairDTO<K, V>> entries) {
