...
public class UniversalElementRepresentation extends AbstractElementRepresentation implements Comparable<UniversalElementRepresentation> {
    ...
    public enum UniversalElementType { INTERFACE, CLASS, ENUM, FIELD, METHOD, METHOD_PARAMETER, LOCAL_VARIABLE, /*OBJECT_INSTANCE,*/ UNKNOWN, REFERENCE /*, COLLECTION, MAP*/, COLLECTION_ELEMENT }
