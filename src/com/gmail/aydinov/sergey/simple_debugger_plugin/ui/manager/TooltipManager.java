...
public class TooltipManager {
    ...
    /**
     * Устанавливает функцию, которая возвращает текст тултипа для конкретного TableItem.
     */
    ...
    /**
     * Получение индекса колонки по координате X (аналог getColumnIndexAtPoint из твоего класса)
     */
