...
public class EvaluateTabContent {
    ...
    public Combo getClassCombo() { return classCombo; }
    public Combo getMethodCombo() { return methodCombo; }
    public Button getInvokeButton() { return invokeBtn; }
    public Text getResultField() { return resultField; }
}
